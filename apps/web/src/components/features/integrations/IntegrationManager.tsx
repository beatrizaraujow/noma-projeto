              ...
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    {['zapier', 'make', 'custom_webhook'].includes(integration.type) && integration.config?.webhookUrl && (
                      <div className="mt-2 p-2 rounded bg-blue-50 text-blue-800 text-xs">
                        <strong>Webhook URL:</strong> {integration.config.webhookUrl}
                      </div>
                    )}
