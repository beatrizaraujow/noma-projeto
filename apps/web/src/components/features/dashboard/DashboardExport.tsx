...
export default function DashboardExport({ workspaceId, token }: DashboardExportProps) {
  ...
  return (
    <Card className="p-6 bg-[#1a1a1f] border-gray-800 text-white">
      <h3 className="text-lg font-semibold mb-4 text-white">Export Dashboard</h3>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Button
          ...
          disabled={exporting}
          variant="outline"
          className="flex items-center gap-2 bg-[#25252b] border-gray-700 text-gray-200 hover:bg-[#2f2f36]"
        >
